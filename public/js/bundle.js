...
var showAlert = function showAlert(type, msg) {
  hideAlert();
  var alertEl = "\n  <div class=\"alert alert--".concat(type, "\">\n    <h3 class=\"alert__heading\">").concat(msg, "</h3>\n  </div>\n    ");
        ...
        switch (_context.prev = _context.next) {
          ...
          case 3:
            ...
            if (result.data.status === 'success') {
              (0, _alert.showAlert)('success', 'Welcome, your account is created!');
              setTimeout(function () {
                location.assign('/');
              }, 1500);
            }
...
var login = /*#__PURE__*/function () {
  var _ref2 = _asyncToGenerator( /*#__PURE__*/regeneratorRuntime.mark(function _callee2(type, mobile, password) {
    var result;
      ...
      while (1) {
        switch (_context2.prev = _context2.next) {
          case 0:
            ...
            return (0, _axios.default)({
              method: 'POST',
              url: "http://127.0.0.1:7000/api/v1/".concat(type, "/login"),
              data: {
                mobile: mobile,
                password: password
              }
      ...
      while (1) {
        switch (_context3.prev = _context3.next) {
          ...
          case 7:
            ...
            (0, _alert.showAlert)('error', 'Problem in logging out');
...
},{"axios":"../../node_modules/axios/index.js","./alert":"alert.js"}],"allusers.js":[function(require,module,exports) {
"use strict";
...
var allUsers = /*#__PURE__*/function () {
  var _ref = _asyncToGenerator( /*#__PURE__*/regeneratorRuntime.mark(function _callee(next) {
    var nextPage, filterIt, deleverIcon, date, result, allusers;
    return regeneratorRuntime.wrap(function _callee$(_context) {
      while (1) {
        switch (_context.prev = _context.next) {
          case 0:
            nextPage = String(next);
            filterIt = 'connectionFor';
            _context.prev = 2;
            date = new Date();
            _context.next = 6;
            return (0, _axios.default)({
              method: 'GET',
              url: "http://127.0.0.1:7000/api/v1/admin?page=".concat(nextPage, "&limit=10&sort=").concat(filterIt)
            });

          case 6:
            result = _context.sent;
            allusers = result.data.data.users;
            allusers.forEach(function (user) {
              var _todayStatus$;

              var todayStatus = user.deliveries.filter(function (el) {
                return el.deliveredAt === +date.getDate();
              });
              deleverIcon = ((_todayStatus$ = todayStatus[0]) === null || _todayStatus$ === void 0 ? void 0 : _todayStatus$.status) === true ? 'delevered' : 'not-delevered';
              var markup = "\n        <div class=\"users__box\">\n        <img src=\"../img/users/".concat(user.photo, "\" alt=\"\" class=\"users__img\" />\n        <a href='/").concat(user.slug, "' class=\"users__name\">").concat(user.name, "</a>\n        <div class=\"users__litre\">").concat(user.connectionFor, "L</div>\n        <div class=\"users__status\">\n          <div class=\"users__status-text\">").concat(deleverIcon, "</div>\n          <div class=\"users__status-icon ").concat(deleverIcon, "\"></div>\n        </div>\n      </div>\n        ");
              var filterEl = document.querySelector('.users__filter');
  ...
  return function allUsers(_x) {
    return _ref.apply(this, arguments);
  };
}();

exports.allUsers = allUsers;
},{"axios":"../../node_modules/axios/index.js"}],"status.js":[function(require,module,exports) {
"use strict";

Object.defineProperty(exports, "__esModule", {
  value: true
});
exports.waterDelivered = void 0;
...
var waterDelivered = /*#__PURE__*/function () {
  var _ref = _asyncToGenerator( /*#__PURE__*/regeneratorRuntime.mark(function _callee(type, user, date) {
    var result, _result;
  ...
  return function waterDelivered(_x, _x2, _x3) {
    return _ref.apply(this, arguments);
  };
}();

exports.waterDelivered = waterDelivered;
      ...
      while (1) {
        switch (_context.prev = _context.next) {
          case 0:
            ...
            return (0, _axios.default)({
              method: 'PATCH',
              url: "http://127.0.0.1:7000/api/v1/".concat(type, "/updateMe"),
              data: data
            });
...
var updatePassword = /*#__PURE__*/function () {
  var _ref = _asyncToGenerator( /*#__PURE__*/regeneratorRuntime.mark(function _callee(type, passwordCurrent, password, passwordConfirm) {
    var result;
    return regeneratorRuntime.wrap(function _callee$(_context) {
      while (1) {
        switch (_context.prev = _context.next) {
          case 0:
            ...
            return (0, _axios.default)({
              method: 'POST',
              url: "http://127.0.0.1:7000/api/v1/".concat(type, "/updatePassword"),
              data: {
  ...
  return function updatePassword(_x, _x2, _x3, _x4) {
    return _ref.apply(this, arguments);
  };
}();

exports.updatePassword = updatePassword;
},{"axios":"../../node_modules/axios/index.js","./alert":"alert.js"}],"sendQuery.js":[function(require,module,exports) {
"use strict";
...
var sendQuery = /*#__PURE__*/function () {
      ...
      while (1) {
        switch (_context.prev = _context.next) {
          ...
          case 3:
            ...
            if (result.data.status === 'success') {
              (0, _alert.showAlert)('success', 'Your Query is successfully sent!');
            }
  ...
  return function sendQuery(_x, _x2, _x3) {
    return _ref.apply(this, arguments);
  };
}();
...
var logoutBtn = document.querySelector('.navbar__button--logout');
var allUserBtn = document.querySelector('#alluser-btn');
var filterBy = document.querySelector('#filter');
var prevBtn = document.querySelector('.paginate__prev');
var nextBtn = document.querySelector('.paginate__next');
var calenderAdmin = document.querySelector('#calender__admin');
var calenderUser = document.querySelector('#calender__user');
var updateProfileForm = document.querySelector('#updateData');
var updatePasswordForm = document.querySelector('#updatePassword');
var contactForm = document.querySelector('.contact__form');
var allSections = document.querySelectorAll('section');

var reveal = function reveal(entries, observer) {
...
var sectionObserver = new IntersectionObserver(reveal, {
  root: null,
  threshold: 0.2
});
...
if (signupForm) {
  signupForm.addEventListener('submit', function (e) {
    ...
    var connectionFor = document.querySelector('#connectionFor').value;
...
if (loginForm) {
  loginForm.addEventListener('submit', function (e) {
    ...
    (0, _login.login)(type, mobile, password);
  });
}
...
if (allUserBtn) {
  allUserBtn.addEventListener('click', (0, _allusers.allUsers)(next));
}

if (nextBtn) {
  nextBtn.addEventListener('click', function () {
    next++;
    var userBox = document.querySelectorAll('.users__box');
    userBox.forEach(function (box) {
      return box.remove();
    });
    (0, _allusers.allUsers)(next);
  });
}
...
if (calenderAdmin) {
  var user = JSON.parse(calenderAdmin.dataset.user);
  var date = new Date();
  var days = new Date(date.getFullYear(), date.getMonth(), 0).getDate();

  for (var i = 1; i <= days; i++) {
    var markup = "\n    <div class=\"calender__box\">\n    <div class=\"calender__date\">".concat(i, "</div>\n    <div class=\"calender__date-status\"></div>\n    <div class=\"calender__date-icons\">\n    <img src=\"../img/icons/check.png\" alt=\"success\" class=\"success\" />\n    <img src=\"../img/icons/remove.png\" alt=\"fail\" class=\"fail\" />\n    </div>\n    </div>\n    ");
    calenderAdmin.insertAdjacentHTML('beforeend', markup);
  }

  var calenderBoxes = document.querySelectorAll('.calender__box');
  var calenderDatesStatus = document.querySelectorAll('.calender__date-status');
  var rightTicks = document.querySelectorAll('.success');
  var crossTicks = document.querySelectorAll('.fail');
  user.deliveries.forEach(function (delivery) {
    if (delivery.status) {
  ...
  calenderBoxes.forEach(function (box) {
    box.addEventListener('click', function (e) {
      e.preventDefault();
      var rightBtn = box.querySelector('.success');
      var wrongBtn = box.querySelector('.fail');
      var calenderDate = +box.querySelector('.calender__date').textContent;
      if (e.target !== rightBtn && e.target !== wrongBtn) return;

      if (e.target === rightBtn) {
        (0, _status.waterDelivered)('success', user, calenderDate);
        e.target.classList.add("".concat(e.target.alt, "-active"));
        box.querySelector('.calender__date-status').textContent = e.target.alt;
        box.classList.add('active');
      }

      if (e.target === wrongBtn) {
        (0, _status.waterDelivered)('fail', user, calenderDate);
        e.target.classList.add("".concat(e.target.alt, "-active"));
        box.querySelector('.calender__date-status').textContent = e.target.alt;
...
if (calenderUser) {
  var _JSON$parse = JSON.parse(calenderUser.dataset.user),
      _JSON$parse2 = _slicedToArray(_JSON$parse, 1),
      _user = _JSON$parse2[0];

  var _date = new Date();

  var _days = new Date(_date.getFullYear(), _date.getMonth(), 0).getDate();

  console.log(_user);

  for (var _i2 = 1; _i2 <= _days; _i2++) {
    var _markup = "\n    <div class=\"calender__box\">\n    <div class=\"calender__date\">".concat(_i2, "</div>\n    <div class=\"calender__date-status\"></div>\n    <div class=\"calender__date-icons\">\n    &nbsp;\n    &nbsp;\n    </div>\n    </div>\n    ");

    calenderUser.insertAdjacentHTML('beforeend', _markup);
  }

  var _calenderBoxes = document.querySelectorAll('.calender__box');

  var _calenderDatesStatus = document.querySelectorAll('.calender__date-status');

  _user.deliveries.forEach(function (delivery) {
    if (delivery.status) {
      _calenderBoxes[+delivery.deliveredAt - 1].classList.add('active');

      _calenderDatesStatus[+delivery.deliveredAt - 1].textContent = 'success';
    }

    if (!delivery.status) {
      _calenderBoxes[+delivery.deliveredAt - 1].classList.add('inactive');

      _calenderDatesStatus[+delivery.deliveredAt - 1].textContent = 'fail';
    }
  });
}
...
if (updateProfileForm) {
  updateProfileForm.addEventListener('submit', function (e) {
    ...
    type = mobile === '7987109019' ? 'admin' : 'users';
    (0, _updateData.updateData)(type, form);
  });
}
...
if (updatePasswordForm) {
  updatePasswordForm.addEventListener('submit', function (e) {
    e.preventDefault();
    var passwordCurrent = document.querySelector('#passwordcurrent').value;
    var password = document.querySelector('#password').value;
    var passwordConfirm = document.querySelector('#passwordconfirm').value;
    (0, _updatePassword.updatePassword)(type, passwordCurrent, password, passwordConfirm);
  });
}
